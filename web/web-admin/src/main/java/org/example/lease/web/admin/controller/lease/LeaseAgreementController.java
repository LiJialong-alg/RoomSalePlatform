package org.example.lease.web.admin.controller.lease;
...
import org.example.lease.model.enums.LeaseStatus;
import org.example.lease.web.admin.service.LeaseAgreementService;
import org.example.lease.web.admin.vo.agreement.AgreementQueryVo;
import org.example.lease.web.admin.vo.agreement.AgreementVo;
...
public class LeaseAgreementController {
    ...
    public Result<IPage<AgreementVo>> page(@RequestParam long current, @RequestParam long size, AgreementQueryVo queryVo) {
        Page<AgreementVo> agreementVoPage = new Page<AgreementVo>(current, size);

package org.example.lease.web.admin.controller.system;
...
import org.example.lease.web.admin.service.SystemUserService;
...
public class SystemUserController {
    ...
    public Result<SystemUserItemVo> getById(@RequestParam Long id) {
        SystemUserItemVo res = systemUserService.getSystemUserById(id);
        return Result.ok(res);
    }
    ...
    public Result<Boolean> isUsernameExists(@RequestParam String username) {
        boolean res = systemUserService.count(new LambdaQueryWrapper<SystemUser>().eq(SystemUser::getUsername, username)) == 0;
        return Result.ok(res);
    }
